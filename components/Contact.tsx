...
const Contact = () => {
  ...
  const handleCopyEmail = () => {
    const email = "selvinpaulgomathi@gmail.com";
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center mt-6 hover:scale-110 transition-all duration-500">
        <PiButterflyLight  size={27} className="" />
      </div>
      <form
      ...
      >
        <div className="flex justify-between items-center gap-2">
          <input
            className="h-10 md:h-12 2xl:h-14 px-4 rounded borderBlack dark:bg-[#151313]  transition-all outline-none w-1/2  focus:border-blue-500 placeholder-gray-800 text-gray-900 dark:placeholder-[#eaeaeab9] dark:text-[#fdfdfd]"
            type="text"
            required
            maxLength={500}
        ...
        <textarea
          className="h-40 my-3 rounded-md borderBlack p-4 dark:bg-[#151313]  transition-all outline-none focus:border-blue-500 placeholder-gray-800 text-gray-900 dark:placeholder-[#eaeaeab9] dark:text-[#fdfdfd]"
          name="message"
