...
const yoe = (() => {
  const yr = Math.floor(experienceMetrics.totalMonths / 12);
  const mo = experienceMetrics.totalMonths % 12;
  return { yr, mo };
})();
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-10 lg:gap-14 items-start">
        ...
        <div className="flex flex-col gap-[18px]">
          ...
          {/* Stats grid */}
          <div className="grid grid-cols-3 border border-white/[0.07] dark:border-white/[0.07] border-black/10 rounded-[14px] overflow-hidden bg-gray-50 dark:bg-[#101015]">
            {/* Projects shipped */}
            <div className="p-[18px_20px]">
              <div className="font-semibold text-[32px] tracking-[-0.02em] leading-none flex items-baseline gap-[6px] text-gray-900 dark:text-[#ededee]">
                {projectsData.length}<span className="text-[#f5c518]">+</span>
              </div>
              <div
            ...
            {/* Split: Open Source / Clients */}
            <div className="border-l border-white/[0.07] dark:border-white/[0.07] border-black/10 grid grid-rows-2">
              <div className="px-[18px] py-3 flex items-center justify-between gap-3 border-b border-white/[0.07] dark:border-white/[0.07] border-black/10">
                <span
                ...
                <span className="font-semibold text-[15px] text-gray-900 dark:text-[#ededee]">
                  12<span className="text-[11px] font-medium text-gray-400 dark:text-[#8a8a93] ml-[3px]">repos</span>
                </span>
              </div>
              <div className="px-[18px] py-3 flex items-center justify-between gap-3">
                ...
                <span className="font-semibold text-[15px] text-gray-900 dark:text-[#ededee]">
                  F500<span className="text-[11px] font-medium text-gray-400 dark:text-[#8a8a93] ml-[3px]">+</span>
                </span>
              </div>
            </div>
          </div>
