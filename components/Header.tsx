...
const Header = () => {
  ...
  return (
    <header className="z-[999] md:border-r border-black/20 fixed bottom-0 border-t-2 left-0 right-0 w-full h-16 sm:bottom-0 md:bottom-0 md:w-16 md:h-screen dark:border-white/20 md:scale-150">
